  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Eduvora?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          <br />
          <br />
          At Eduvora, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Eduvora is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Eduvora by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Eduvora family today and let&apos;s
        ...
        <br />
        <span className="text-[22px]">MuhammadAbdullah&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Eduvora
        </h5>
        <br />
        <br />
        <br />
