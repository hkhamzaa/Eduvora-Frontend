...
const Item: FC<itemProps> = ({ title, to, icon, selected, setSelected, onNavigate }) => {
  return (
    <MenuItem
      ...
      >
        <Menu>
          ...
          <MenuItem
            ...
            icon={isCollapsed ? <ArrowForwardIosIcon className="text-black dark:text-white"/> : undefined}
            style={{
          ...
          >
            {!isCollapsed && (
              ...
              >
                <h3
                  className="text-[25px] font-Poppins uppercase dark:text-white text-black cursor-pointer"
                  onClick={() => router.push("/")}
                >
                  Eduvora
                </h3>
